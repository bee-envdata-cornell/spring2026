...
sched = @chain sched begin
 ...
 @transform! :subgroup = ifelse.(:is_first, :subgroup, "")
 @transform 
end
...
<table>
  ...
  <tbody>
    ...
    <tr class = "dataRow">
      <td style = "background-color: lightgrey; text-align: left;">Class Wrap-Up</td>
      <td style = "background-color: lightgrey; text-align: center;">TBD</td>
      <td style = "background-color: lightgrey; text-align: center;">TBD</td>
      <td style = "background-color: lightgrey; text-align: left;">During Finals Week</td>
      <td style = "background-color: lightgrey; text-align: left;">Project Report Due</td>
    </tr>
  </tbody>
</table>

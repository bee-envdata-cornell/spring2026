...
<table>
  ...
  <tbody>
    ...
    <tr class = "dataRow">
      ...
      <td style = "background-color: lightgrey; text-align: left;">Probability Models and EDA</td>
    ...
    <tr class = "dataRow">
      ...
      <td style = "text-align: left;">Linear Regression: Uses and Misuses</td>
    ...
    <tr class = "dataRow">
      ...
      <td style = "text-align: center;">Wed</td>
      <td style = "text-align: left;">Maximum Likelihood Estimation and Fisher Information</td>
      <td style = "text-align: left;"></td>
    </tr>
    <tr class = "dataRow">
      <td style = "text-align: left;"></td>

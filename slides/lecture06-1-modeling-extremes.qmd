...
&= \mathbb{P}(X \leq z)^n = \left[F_X(z)\right]^n
\end{align*}
$$
...
\begin{aligned}
\max\{x_1, \ldots, &x_{2n}\}\\
&= \max\{\max\{x_1, \ldots, x_n\}, \max\{x_{n+1}, \ldots, x_{2n}\} \}
\end{aligned}
$$
...
#| code-overflow: wrap
#| fig-align: center
#| label: fig-surge-max-detrend
#| fig-cap: Annual maximasurge data from the San Francisco, CA tide gauge.

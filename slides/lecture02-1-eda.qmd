...
#| code-fold: true
#| echo: true
#| label: fig-ozone-hist
#| fig-cap: Histogram of Ozone measurements in Air Quality Dataset

# normalize=:pdf turns the y-axis from a raw count to a density to make more comparable with a PDF
pozone = histogram(skipmissing(aq[!, :Ozone]), xlabel="Ozone (ppb)", ylabel="Density", normalize=:pdf, label="Data")
```
:::
::::
...
# densities of residual distributions
p2 = qqplot(Normal, mm_samps, linewidth=3, markersize=6, title="Normal Q-Q Plot")
xlabel!(p2, "Theoretical Values")
ylabel!(p2, "Empirical Values")
...
## Q-Q Plot for Ozone Data

```{julia}
#| label: fig-qq-ozone
#| fig-cap: QQ Plot comparing ozone data with LogNormal distribution
#| echo: true
#| code-fold: true
...
plot!(pozone, xlims=(0, 300), rightmargin=5mm)
plot(p1, pozone, size=(1200, 525))
```

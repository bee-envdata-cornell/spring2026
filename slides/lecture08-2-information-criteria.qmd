---
title: "Model Comparison and Information Criteria"
subtitle: "Lecture 20"
...
$$\begin{align}
Q(\tilde{y}_i) &= \mathbb{E}_Y \left[p(\tilde{y} | \theta_{MLE})\right] \\
&= \int_Y p(\tilde{y} | \theta_{\text{MLE}}) p(\tilde{y})\,d\tilde{y}.
\end{align}$$
...
In other words, if the "true" model is among the choices, AIC may not choose it, but BIC will. But AIC will choose the model with better predictive skill.

---
title: "Quantifying Model Uncertainties"
subtitle: "Lecture 31"
...
![Representation of Planetary Energy Balance](https://courses.ems.psu.edu/meteo469/sites/meteo469/files/lesson04/ebm_0_dim.gif)
...
:::
::: {.column width=40%}
![Two Layer EBM Schematic](https://content.cld.iop.org/journals/1748-9326/13/8/084003/revision2/erlaad2e4f1_hr.jpg)
...
pretty_table(DataFrame(Parameters=parnames, MLE=θ_iid_rd); backend=:markdown)
```
:::
::: {.column width=50%}
```{julia}
...
param_df = DataFrame(Parameters=parnames, IID=θ_iid_exp, AR=θ_ar_rd)
...
pretty_table(param_df[5:end, :]; backend=:markdown)
```
:::
::::
...
::: {.column width=60%}
```{julia}
#| label: fig-ebm-residuals
#| fig-cap: Residuals of EBM 
#| echo: true
#| code-fold: true
...
```{julia}
#| label: fig-bootstrap-sims
#| fig-cap: Bootstrapped realizations from EBM
#| echo: true
#| code-fold: true
...
#| echo: true
#| code-overflow: wrap
#| label: fig-ebm-bootstrap-results
#| fig-cap: EBM Bootstrap Parameter Distributions

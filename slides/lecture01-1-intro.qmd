...
- Probability Models (Linear/Generalized Linear Models, Time Series, Extreme Values, Causal Reasoning)
- Simulation Methods (Monte Carlo, The Bootstrap, Missing Data)  
- Hypothesis Testing (Model Evaluation, Cross-Validation, Information Criteria)

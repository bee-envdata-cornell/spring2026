...
$$\begin{aligned}
\tilde{\sigma}^2_n &= \mathbb{V}\left[Y_i\right] \\
...
$$\begin{aligned}
\mathbb{V}\left[\frac{1}{2}(h(X_i) + h(Y_i)\right] &= \frac{1}{4}\left[\mathbb{V}[h(X_i)] + \mathbb{V}[h(Y_i)] + \\
&\qquad\qquad 2\text{Cov}(h(X_i), h(Y_i)\right] \\

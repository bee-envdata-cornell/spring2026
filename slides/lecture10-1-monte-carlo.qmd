...
1. Generate a "large number" of Gaussian-distributed 
...
This is a useful technique particularly when models are nonlinear, making analytic transformations and integrals cumbersome.
...
$$\mathbb{E}\left[\frac{1}{n}\sum_{i=1}^n Y_i\right] = \frac{1}{n} \sum_{i=1}^n \mathbb{E}\left[\mathbb{Y}_i\right] = \mu$$
...
$$\tilde{\sigma}_n^2 = \frac{1}{n-1} \sum_{i=1}^n \left(Y_i - \tilde{\mu}_n)^2$$

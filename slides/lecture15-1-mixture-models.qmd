...
&= \sum_{i=1}^n \frac{\lambda_k f_k(x_i; \theta)}{\sum_{j=1}^K \pi_j f_j(x_i; \theta)} \frac{1}{f_j(x_i, \theta)} \frac{\partial f_k(y_i; \theta)}{\partial \theta_k} \\
&= \sum_{i=1}^n \frac{\lambda_k f_k(x_i; \theta)}{\sum_{j=1}^K \pi_j f_j(x_i; \theta)} \frac{\partial \log f_j(x_i; \theta)}{\partial \theta_k}
\end{aligned}$$

...
## Approaches to Non-Parametric Bootstrapping Structured Data

- **Transformations**: Transform to uncorrelated data (principal components, etc.), sample, transform back.
- **Block bootstrap**
...
This lets us use more general probability models, such as a simulation or statistical model, instead of relying only on the empirical CDF.
...
## Bootstrap as Monte Carlo

The bootstrap is a Monte Carlo procedure, but focused on **inference** vs. **forward simulation**:

**Bootstrap question** "if I had a different sample (*conditional on the bootstrap principle*), what could I have inferred"?

## Bootstrap Distribution and Monte Carlo

Could we use a bootstrap distribution for forward MC?
...
**Wednesday**: Bootstrap Example With Residual Resampling

...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, opacityback=0, opacitybacktitle=0.6, breakable, bottomtitle=1mm, leftrule=.75mm, rightrule=.15mm, titlerule=0mm, toprule=.15mm, colframe=quarto-callout-important-color-frame, colbacktitle=quarto-callout-important-color!10!white, toptitle=1mm, bottomrule=.15mm, title={Due Date}, arc=.35mm, left=2mm, colback=white]

Friday, 2/20/26, 9:00pm

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, coltitle=black, opacityback=0, opacitybacktitle=0.6, breakable, bottomtitle=1mm, leftrule=.75mm, rightrule=.15mm, titlerule=0mm, toprule=.15mm, colframe=quarto-callout-tip-color-frame, colbacktitle=quarto-callout-tip-color!10!white, toptitle=1mm, bottomrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, arc=.35mm, left=2mm, colback=white]

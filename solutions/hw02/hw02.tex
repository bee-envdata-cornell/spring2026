...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, opacitybacktitle=0.6, leftrule=.75mm, coltitle=black, colback=white, colbacktitle=quarto-callout-important-color!10!white, arc=.35mm, bottomtitle=1mm, rightrule=.15mm, left=2mm, toptitle=1mm, breakable, opacityback=0, titlerule=0mm, title={Due Date}, bottomrule=.15mm, colframe=quarto-callout-important-color-frame]

Friday, 2/20/26, 9:00pm

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, opacitybacktitle=0.6, leftrule=.75mm, coltitle=black, colback=white, colbacktitle=quarto-callout-tip-color!10!white, arc=.35mm, bottomtitle=1mm, rightrule=.15mm, left=2mm, toptitle=1mm, breakable, opacityback=0, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, bottomrule=.15mm, colframe=quarto-callout-tip-color-frame]

...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, colback=white, coltitle=black, titlerule=0mm, opacitybacktitle=0.6, toprule=.15mm, left=2mm, breakable, opacityback=0, colbacktitle=quarto-callout-important-color!10!white, bottomrule=.15mm, arc=.35mm, rightrule=.15mm, toptitle=1mm, title={Due Date}, leftrule=.75mm, colframe=quarto-callout-important-color-frame]

Friday, 2/20/26, 9:00pm

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, colback=white, coltitle=black, titlerule=0mm, opacitybacktitle=0.6, toprule=.15mm, left=2mm, breakable, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm, arc=.35mm, rightrule=.15mm, toptitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, leftrule=.75mm, colframe=quarto-callout-tip-color-frame]

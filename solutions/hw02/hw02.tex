...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, breakable, opacityback=0, titlerule=0mm, colbacktitle=quarto-callout-important-color!10!white, bottomtitle=1mm, opacitybacktitle=0.6, rightrule=.15mm, colframe=quarto-callout-important-color-frame, colback=white, leftrule=.75mm, title={Due Date}, coltitle=black, bottomrule=.15mm, left=2mm, toptitle=1mm, arc=.35mm]

Friday, 2/20/26, 9:00pm

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, breakable, opacityback=0, titlerule=0mm, colbacktitle=quarto-callout-tip-color!10!white, bottomtitle=1mm, opacitybacktitle=0.6, rightrule=.15mm, colframe=quarto-callout-tip-color-frame, colback=white, leftrule=.75mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, coltitle=black, bottomrule=.15mm, left=2mm, toptitle=1mm, arc=.35mm]

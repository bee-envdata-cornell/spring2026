...
\begin{tcolorbox}[enhanced jigsaw, breakable, title={Due Date}, colframe=quarto-callout-important-color-frame, opacityback=0, colbacktitle=quarto-callout-important-color!10!white, leftrule=.75mm, titlerule=0mm, coltitle=black, bottomrule=.15mm, bottomtitle=1mm, toptitle=1mm, arc=.35mm, toprule=.15mm, rightrule=.15mm, opacitybacktitle=0.6, left=2mm, colback=white]

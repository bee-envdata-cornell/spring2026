...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, bottomtitle=1mm, titlerule=0mm, opacitybacktitle=0.6, breakable, colbacktitle=quarto-callout-important-color!10!white, colback=white, leftrule=.75mm, left=2mm, coltitle=black, colframe=quarto-callout-important-color-frame, toprule=.15mm, opacityback=0, rightrule=.15mm, title={Due Date}, arc=.35mm, bottomrule=.15mm]

Friday, 2/20/26, 9:00pm

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, bottomtitle=1mm, titlerule=0mm, opacitybacktitle=0.6, breakable, colbacktitle=quarto-callout-tip-color!10!white, colback=white, leftrule=.75mm, left=2mm, coltitle=black, colframe=quarto-callout-tip-color-frame, toprule=.15mm, opacityback=0, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, arc=.35mm, bottomrule=.15mm]

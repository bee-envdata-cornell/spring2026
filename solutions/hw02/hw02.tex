...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, opacityback=0, colbacktitle=quarto-callout-important-color!10!white, titlerule=0mm, opacitybacktitle=0.6, colback=white, coltitle=black, bottomrule=.15mm, breakable, bottomtitle=1mm, left=2mm, toprule=.15mm, leftrule=.75mm, toptitle=1mm, title={Due Date}, arc=.35mm, colframe=quarto-callout-important-color-frame]

Friday, 2/20/26, 9:00pm

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, opacitybacktitle=0.6, colback=white, coltitle=black, bottomrule=.15mm, breakable, bottomtitle=1mm, left=2mm, toprule=.15mm, leftrule=.75mm, toptitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, arc=.35mm, colframe=quarto-callout-tip-color-frame]

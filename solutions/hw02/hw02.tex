...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, opacitybacktitle=0.6, breakable, left=2mm, titlerule=0mm, colbacktitle=quarto-callout-important-color!10!white, bottomrule=.15mm, toptitle=1mm, toprule=.15mm, arc=.35mm, colframe=quarto-callout-important-color-frame, colback=white, bottomtitle=1mm, opacityback=0, coltitle=black, title={Due Date}, leftrule=.75mm]

Friday, 2/20/26, 9:00pm

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, opacitybacktitle=0.6, breakable, left=2mm, titlerule=0mm, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm, toptitle=1mm, toprule=.15mm, arc=.35mm, colframe=quarto-callout-tip-color-frame, colback=white, bottomtitle=1mm, opacityback=0, coltitle=black, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, leftrule=.75mm]

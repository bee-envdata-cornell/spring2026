...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colframe=quarto-callout-important-color-frame, toprule=.15mm, colbacktitle=quarto-callout-important-color!10!white, colback=white, breakable, bottomrule=.15mm, toptitle=1mm, rightrule=.15mm, title={Due Date}, left=2mm, opacityback=0, titlerule=0mm, coltitle=black, opacitybacktitle=0.6, bottomtitle=1mm, leftrule=.75mm]

Friday, 2/20/26, 9:00pm

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colframe=quarto-callout-tip-color-frame, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, colback=white, breakable, bottomrule=.15mm, toptitle=1mm, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, left=2mm, opacityback=0, titlerule=0mm, coltitle=black, opacitybacktitle=0.6, bottomtitle=1mm, leftrule=.75mm]

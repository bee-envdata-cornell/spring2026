...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, colbacktitle=quarto-callout-important-color!10!white, opacityback=0, breakable, left=2mm, toptitle=1mm, colback=white, bottomtitle=1mm, titlerule=0mm, arc=.35mm, coltitle=black, leftrule=.75mm, colframe=quarto-callout-important-color-frame, title={Due Date}, rightrule=.15mm, bottomrule=.15mm, opacitybacktitle=0.6]

Friday, 2/20/26, 9:00pm

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, opacityback=0, breakable, left=2mm, toptitle=1mm, colback=white, bottomtitle=1mm, titlerule=0mm, arc=.35mm, coltitle=black, leftrule=.75mm, colframe=quarto-callout-tip-color-frame, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, rightrule=.15mm, bottomrule=.15mm, opacitybacktitle=0.6]

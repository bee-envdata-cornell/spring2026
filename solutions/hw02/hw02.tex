...
\begin{tcolorbox}[enhanced jigsaw, breakable, toptitle=1mm, toprule=.15mm, left=2mm, colback=white, opacityback=0, arc=.35mm, titlerule=0mm, bottomrule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-important-color!10!white, leftrule=.75mm, colframe=quarto-callout-important-color-frame, title={Due Date}, rightrule=.15mm, opacitybacktitle=0.6, coltitle=black]

Friday, 2/20/26, 9:00pm

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, breakable, toptitle=1mm, toprule=.15mm, left=2mm, colback=white, opacityback=0, arc=.35mm, titlerule=0mm, bottomrule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, leftrule=.75mm, colframe=quarto-callout-tip-color-frame, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, rightrule=.15mm, opacitybacktitle=0.6, coltitle=black]

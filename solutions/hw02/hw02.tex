...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, titlerule=0mm, title={Due Date}, arc=.35mm, colframe=quarto-callout-important-color-frame, opacitybacktitle=0.6, left=2mm, bottomrule=.15mm, toptitle=1mm, coltitle=black, breakable, colbacktitle=quarto-callout-important-color!10!white, leftrule=.75mm, rightrule=.15mm, toprule=.15mm, bottomtitle=1mm, colback=white]

Friday, 2/20/26, 9:00pm

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, opacityback=0, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, arc=.35mm, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, left=2mm, bottomrule=.15mm, toptitle=1mm, coltitle=black, breakable, colbacktitle=quarto-callout-tip-color!10!white, leftrule=.75mm, rightrule=.15mm, toprule=.15mm, bottomtitle=1mm, colback=white]

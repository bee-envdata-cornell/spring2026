...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, title={Due Date}, toprule=.15mm, colbacktitle=quarto-callout-important-color!10!white, coltitle=black, opacitybacktitle=0.6, titlerule=0mm, opacityback=0, colframe=quarto-callout-important-color-frame, colback=white, rightrule=.15mm, leftrule=.75mm, arc=.35mm, bottomrule=.15mm, breakable, toptitle=1mm, left=2mm]

Friday, 2/20/26, 9:00pm

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, coltitle=black, opacitybacktitle=0.6, titlerule=0mm, opacityback=0, colframe=quarto-callout-tip-color-frame, colback=white, rightrule=.15mm, leftrule=.75mm, arc=.35mm, bottomrule=.15mm, breakable, toptitle=1mm, left=2mm]

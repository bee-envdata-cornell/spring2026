...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, titlerule=0mm, breakable, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, title={Due Date}, opacitybacktitle=0.6, rightrule=.15mm, bottomrule=.15mm, leftrule=.75mm, left=2mm, arc=.35mm, colback=white, opacityback=0, colbacktitle=quarto-callout-important-color!10!white, colframe=quarto-callout-important-color-frame]

Friday, 2/20/26, 9:00pm

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, coltitle=black, titlerule=0mm, breakable, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, opacitybacktitle=0.6, rightrule=.15mm, bottomrule=.15mm, leftrule=.75mm, left=2mm, arc=.35mm, colback=white, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame]

...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, left=2mm, colframe=quarto-callout-important-color-frame, colback=white, title={Due Date}, rightrule=.15mm, breakable, coltitle=black, colbacktitle=quarto-callout-important-color!10!white, leftrule=.75mm, opacitybacktitle=0.6, bottomtitle=1mm, titlerule=0mm, arc=.35mm, bottomrule=.15mm, opacityback=0, toprule=.15mm]

...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, coltitle=black, toptitle=1mm, colback=white, colframe=quarto-callout-important-color-frame, bottomrule=.15mm, opacityback=0, breakable, opacitybacktitle=0.6, colbacktitle=quarto-callout-important-color!10!white, left=2mm, title={Due Date}, bottomtitle=1mm, titlerule=0mm, arc=.35mm, rightrule=.15mm, toprule=.15mm]

Friday, 2/20/26, 9:00pm

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, coltitle=black, toptitle=1mm, colback=white, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, opacityback=0, breakable, opacitybacktitle=0.6, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, bottomtitle=1mm, titlerule=0mm, arc=.35mm, rightrule=.15mm, toprule=.15mm]
